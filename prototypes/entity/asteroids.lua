...
local letter = {"a","b","c","d","e","f","g","h","i"}
  ...
  local function asteroid_variation(asteroid_type, suffix, scale, size)
    return
    {
      color_texture =
      {
        filename = "__escape-to-space__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-colour-" .. suffix .. ".png",
    ...
    {
      {
        ...
        icon = "__escape-to-space__/graphics/icons/"..asteroid_name..".png",
        icon_size = 64,
